            ...
            <div class="row">
               <div class="col-md-12">
                 <?php if($this->session->userdata('status') == 'admin'){ ?>
                  <a href="<?= base_url(); ?>admin/user_penjual/is_form" class="btn btn-primary">Tambah</a>
                 <?php } ?>
                  <br>
                  <br>
                        ...
                        <?php 
                           ...
                           <tr>
                              ...
                              <td style="text-align:center;" >
                                 <a href="<?= base_url() ?>admin/user_penjual/is_form/<?= $r->penjual_id;?>" class="btn btn-secondary"><i class="fa fa-edit"></i></a>
                                 <a href="<?= base_url() ?>admin/user_penjual/is_delete/<?= $r->penjual_id;?>" class="btn btn-secondary"><i class="fa fa-trash"></i></a>
                              </td>
                           </tr>
                        <?php $x++; } ?>
                     </tbody>
