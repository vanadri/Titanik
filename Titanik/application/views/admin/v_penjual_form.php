               ...
               <div class="col-md-12">
                 <form action="<?= base_url().uri_string(); ?>" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <input value="<?= (!empty($dtc->no_hp))?$dtc->no_hp:''; ?>" type="number" class="form-control" name="no_hp">
                        </div>
                     </div>
                     <div class="form-group">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-9">
                           <input value="<?= (!empty($dtc->nama_toko))?$dtc->nama_toko:''; ?>" type="text" class="form-control" name="nama_toko">
                        </div>
                     </div>
                     <div class="form-group">
                        <div class="col-md-3">
                     ...
                     <div class="form-group">
                       <div class="row">
                           ...
                           <div class="col-md-2">
                              <a class="btn btn-danger" href="<?= base_url(); ?>admin/user_penjual">Batal</a>
                           </div>
                       </div>
                     </div>
                 </form>
