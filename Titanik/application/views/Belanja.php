        ...
        <div class="navbar-nav ml-auto ">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="#">Belanja<span class="sr-only">(current)</span></a>
            </li>
              <a class="nav-item nav-link" id="btnlogin" href="#"  data-toggle="modal" data-target="#Loginform" >Akun <img style="width: 27px;" src="img/person.png" alt=""></a>
            </li>
          </ul>
        </div>
      </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content" style="background-color: #ffffff;">
      <div class="modal-body">
        <center><img src="img/titanik.png" style="width: 300px;" alt="">
    ...
    <div class="modal-content" style="background-color: #ffffff;">
      <div class="modal-body">
        ...
        <div class="text-center mb-3">
          <button style="color: rgb(255, 255, 255);" type="button" id="btnregis" class="btn btn-primary btn-lg btn-block">Sign in</button>
        </div>
        <center>
...
<!-- -_- -->
  ...
  <center>
    <div class="jumbotron">
        <img class="img2" src="img/sawah.png" alt="">
    </div>
    <div class="container">
      <div class="row">
      ...
      <div class="row row-cols-1 row-cols-md-2">
        <div class="col mb-2 text-center">
          <img style="height: 446px; width: 371px; left: 100px; " src="img/bapak.png" alt="">
        </div>
        <div">
